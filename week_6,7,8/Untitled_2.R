...
library(rsconnect)
rsconnect::setAccountInfo(name='goodjob0823',
                          token='2C3A39D3882004D058532F2AD07EE65E',
                          secret='7QLXzR/FsbGjqzrhDefA8i+wg5ujyemYD1zc0R9i')
...
server <- function(input, output) {
  ...
  output$WordCloud_1 <- renderPlot({
    wordcloud(docs, random.order=FALSE, random.color=TRUE, rot.per=0, 
