...
### function SayHello #####################################################
SayHello <- function (John) {
    print(paste("Hello,", John))
}
...
bmi.level.msg <- CheckBmiLevel(177, 60)
bmi.level.msg # "Your bmi:  19.3698347107438 , 正常範圍"
